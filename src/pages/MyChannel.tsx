...
//     const clientId =
//       "356362454055-p7aek6j0lksv1jvsmfj838812ltfa8eu.apps.googleusercontent.com";
...
//   // Lấy access token từ URL sau khi được redirect
...
//   // Fetch dữ liệu kênh từ YouTube API
...
//         setChannelData(data.items[0]); // Kiểm tra xem data.items có tồn tại không
//       } else {
...
//   // Khi component mount, kiểm tra và lấy access token nếu có
//   useEffect(() => {
...
//               </h1>
//               <p className="text-gray-400">@{channelData.snippet.customUrl}</p>
//               <p className="text-sm text-gray-400">
//                 {channelData.statistics.subscriberCount} người đăng ký
//               </p>
//             </div>
//           </>
//         ) : (
